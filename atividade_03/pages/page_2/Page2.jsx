          ...
          >
            <View style={{ flexDirection: "row", backgroundColor: "#ffffff" }}>
              <View style={styles.container}>
                <Image
                  source={require("../../assets/page2/category/resort.png")} // Caminho correto
                  style={styles.image}
                />
              </View>
              <View style={{ marginInline: 10 }}>
                <Image
                  source={require("../../assets/page2/category/homestay.png")} // Caminho correto
                  style={styles.image}
                />
              </View>
              <View style={styles.container}>
                <Image
                  source={require("../../assets/page2/category/hotel.png")} // Caminho correto
                  style={styles.image}
                />
              </View>
              <View style={styles.container}>
                <Image
                  source={require("../../assets/page2/category/ladge.png")} // Caminho correto
                  style={styles.image}
                />
              </View>
            </View>
            ...
            >
              <View style={styles.container}>
                <Image
                  source={require("../../assets/page2/category/villa.png")} // Caminho correto
                  style={styles.image}
                />
              </View>
              <View style={{ marginInline: 10 }}>
                <Image
                  source={require("../../assets/page2/category/apartement.png")} // Caminho correto
                  style={styles.image}
                />
              </View>
              <View style={styles.container}>
                <Image
                  source={require("../../assets/page2/category/hostel.png")} // Caminho correto
                  style={styles.image}
                />
              </View>
              <View style={styles.container}>
                <Image
                  source={require("../../assets/page2/category/seall.png")} // Caminho correto
                  style={styles.image}
                />
              </View>
            </View>
          ...
          >
            ...
            <Layout>
              ...
              >
                <View style={styles.container}>
                  <Image
                    source={require("../../assets/page2/destinations/dest1.png")} // Caminho correto
                    style={styles.imageDestination}
                  />
                </View>
                <View style={(styles.container, { marginInline: 10 })}>
                  <Image
                    source={require("../../assets/page2/destinations/dest2.png")} // Caminho correto
                    style={styles.imageDestination}
                  />
                </View>
                <View style={styles.container}>
                  <Image
                    source={require("../../assets/page2/destinations/dest3.png")} // Caminho correto
                    style={styles.imageDestination}
                  />
                </View>
              </Layout>
          ...
          >
            ...
            <Layout>
              ...
              >
                <View style={styles.container}>
                  <Image
                    source={require("../../assets/page2/recommends/recife.jpg")} // Caminho correto
                    style={styles.imageRecommend}
                  />
                </View>
                <View style={styles.container}>
                  <Image
                    source={require("../../assets/page2/recommends/rj.jpg")} // Caminho correto
                    style={styles.imageRecommend}
                  />
                </View>
              </Layout>
